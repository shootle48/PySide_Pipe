# ═══════════════════════════════════════════════════════════════════════════
# ✅ BACKUP — เวอร์ชัน QUEUE (default/แนะนำ — เหมือน core/rs485_worker.py ปัจจุบัน)
# ───────────────────────────────────────────────────────────────────────────
# writer thread เดียว + queue → ส่ง pulse ทีละลูก ไม่ซ้อน PLC นับครบทุกชิ้น
# วิธีใช้: ถ้าเผลอเปลี่ยนไป THREADED แล้วอยากกลับ →
